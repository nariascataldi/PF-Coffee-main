...
export default function Newsletter() {
  ...
  const handleClickProducts = (e) => {
    if (e.target.name === "all" && e.target.checked) {
      ...
      setInput({
        ...input,
        products: JSON.parse(e.target.value).map((j) =>
          j.title ? j.title : j.name
        ),
      });
    } else if (e.target.name === "all" && !e.target.checked) {
      setInput({
        ...
        <div className={styles.parentScrolls}>
          ...
          <div className={styles.divScrollProducts}>
            ...
            <input
              ...
              checked={
                newsletter && input.checkedMails.length === newsletter.length
                  ? true
                  : false
              }
            />
              ...
              newsletter.map((p) => (
                <div>
                  ...
                  <input
                    ...
                    value={p.mail}
                    onClick={(e) => handleClickMails(e)}
                    checked={input.checkedMails.includes(p.mail) ? true : false}
                  />
                </div>
              ))}
          </div>

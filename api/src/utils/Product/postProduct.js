...
let postProduct = async(obj)=>{
  try {
    ...
    let { title, price, description, image, stock, cost, margin, diets, categories, providers, disable  } = obj;
    ...
    let prod = await Product.create({ title, price, description, image, stock, cost, margin, disable });  

...
export default function Footer () {
    ...
    return (
        <footer className="text-center" style={{backgroundColor:'#FCEEF0'}}>
          ...
          <div className="container p-4">
            ...
            <section className="mb-4">
                ...
                <button type="button" className="btn btn-primary m-3">
                    <svg width="16" height="16" fill="currentColor" className="bi bi-facebook m-1" viewBox="0 0 16 16">
                ...
                <button type="button" className="btn btn-info m-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter m-1" viewBox="0 0 16 16">
